        ...
        <div className="container">
          <div className="gap-x-[30px] lg:grid lg:grid-cols-12 xl:gap-x-[50px]">
            <div className="lg:col-span-8">
              ...
              <p className="mb-[15px] leading-[27px] text-secondary">{post.postDesc}</p>
              ...
              <div className="single-item pt-[50px]">
                ...
                <div className="content pt-[45px]">
                  ...
                  <p className="leading-[27px] text-secondary">{post.singlePostDesc}</p>
                </div>
              </div>
              <blockquote className="flex fixed-xs:pt-[30px] sm:pt-[75px] sm:pl-[85px]">
                ...
                <p className="max-w-[530px] text-[24px] leading-9">{post.blockquoteText}</p>
              </blockquote>
              <p className="pt-[70px] leading-[27px] text-secondary">{post.postExcerpt}</p>
