      ...
      <div className="project-upper-box pt-[55px] md:pt-[150px]">
        <div className="container">
          ...
          <ul className="info grid grid-cols-1 gap-y-3 sm:grid-cols-2 md:grid-cols-3">
            <li>
              <span className="mr-[5px] text-[#4D5660]">Location:</span>
              {project?.location}
            </li>
            <li>
              <span className="mr-[5px] text-[#4D5660]">Client:</span>
              {project?.clientName}
            </li>
            <li>
              <span className="mr-[5px] text-[#4D5660]">Completed:</span>
              {project.completedDate}
            </li>
            <li>
              <span className="mr-[5px] text-[#4D5660]">Architect:</span>
              {project.architectName}
            </li>
            <li>
              <span className="mr-[5px] text-[#4D5660]">Area:</span>
              {project.squareUnits}
            </li>
          </ul>
        </div>
      ...
      <div className="project-description pt-[40px] md:pt-[80px]">
        <div className="container">
          <div className="content">
            <h2 className="pb-10 text-[36px] leading-[58px]">Description</h2>
            <div
