      ...
      <div className="container max-lg:max-w-full fixed-lg:pr-0">
        <div className="max-md:flex max-md:flex-col-reverse lg:grid lg:grid-cols-2">
          <div className="about-content max-md:pt-10">
            ...
            <h2 className={title}>Over 12 years leading and deeps in interiors industrial</h2>
            <h3 className="mb-12 text-2xl text-secondary">
              We know that good design means <br /> good business
            </h3>
            <p className={desc}>
              Founded by Robert Downey Jr in 2004, we’re an employee-owned firm pursuing a
              democratic design process that values everyone’s input. Today we have more than 150
              people in London, Hong Kong and Sydney providing architecture, interior & urban design
