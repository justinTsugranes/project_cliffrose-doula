...
import { getAllItems, getItemData, getItemsFiles, getPostTags, getPostCategories } from '../../lib';
...
export function getStaticProps(context) {
  ...
  const nextPost = posts[currentPostIndex + 1] ? posts[currentPostIndex + 1] : {};
  const prevPost = posts[currentPostIndex - 1] ? posts[currentPostIndex - 1] : {};
