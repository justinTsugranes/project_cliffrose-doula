...
import { getAllItems, getItemData, getItemsFiles } from '../../lib';
...
export function getStaticProps(context) {
  ...
  const nextProject = projects[currentProjectIndex + 1] ? projects[currentProjectIndex + 1] : {};
  const prevProject = projects[currentProjectIndex - 1] ? projects[currentProjectIndex - 1] : {};
